...
public abstract class Storage implements AutoCloseable {
     ...
     *
     * <p>
     * Este méto03do se utiliza internamente para validar la existencia de un archivo,
    ...
    /**
     * Copia un archivo a otra ruta dentro del mismo almacen usando la operación nativa del backend.
     *
     * @param source Referencia al archivo origen
     * @param target Referencia al archivo destino
     * @throws IOException                    Si ocurre un error de I/O durante la copia
     * @throws StorageObjectNotFoundException Si el archivo origen no existe
     */
    protected abstract void internalCopy(StorageObjectRef source, StorageObjectRef target) throws IOException;
    ...
    /**
     * Copia un archivo a otra ruta dentro del mismo almacen.
     *
     * @param sourcePath Ruta completa del archivo origen
     * @param targetPath Ruta completa del archivo destino
     * @throws IOException                    Si ocurre un error de I/O durante la copia
    ...
    public void copy(String sourcePath, String targetPath) throws IOException {
        ...
        internalCopy(StorageRequest.fromPath(sourcePath), StorageRequest.fromPath(targetPath));
    }
    ...
    /**
     * Genera una URL de eliminación de acceso limitado para un archivo almacenado.
     *
     * @param ref      Referencia al archivo a eliminar
     * @param duration Duración por la cual la URL será válida
     * @return Una URL de eliminación de acceso limitado
     */
    protected abstract URL internalGenerateDeleteSignedUrl(StorageObjectRef ref, Duration duration);
    ...
    /**
     * Genera una URL de eliminación de acceso limitado a partir de la ruta completa del archivo.
     *
     * @param fullPath Ruta completa del archivo en el storage
     * @param duration Duración por la cual la URL será válida
     * @return Una URL de eliminación de acceso limitado
     */
    public URL generateDeleteSignedUrl(String fullPath, Duration duration) {
        return internalGenerateDeleteSignedUrl(StorageRequest.fromPath(fullPath), duration);
    }

    /**
     * Genera una URL de eliminación de acceso limitado a partir del nombre y directorio del archivo.
     *
     * @param filename  Nombre del archivo
     ...
     * @return Una URL de eliminación de acceso limitado
     */
    public URL generateDeleteSignedUrl(String filename, String directory, Duration duration) {
        return internalGenerateDeleteSignedUrl(new StorageObjectRef(directory, filename), duration);
    }

    /**
     * Genera una URL de eliminación de acceso limitado a partir de un {@link StorageObjectRef}.
     *
     * @param ref      Referencia al archivo a eliminar
     * @param duration Duración por la cual la URL será válida
     * @return Una URL de eliminación de acceso limitado
     */
    public URL generateDeleteSignedUrl(StorageObjectRef ref, Duration duration) {
        return internalGenerateDeleteSignedUrl(ref, duration);
    }
